  ...
  publications {
    register("mavenJava", MavenPublication::class) {
      ...
      pom {
        ...
        description.set("Kotest extension for h2")
        url.set("http://www.github.com/kotest/kotest-extensions-h2")

        scm {
          connection.set("scm:git:http://www.github.com/kotest/kotest-extensions-h2")
